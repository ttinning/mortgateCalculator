...
export default function OverpaymentSavings({ monthsSaved, interestSaved }) {
  ...
  return (
    <div className="rounded-lg bg-green-50 dark:bg-green-950 p-4 ring-1 ring-green-200 dark:ring-green-800">
      <h3 className="text-sm font-semibold text-green-900 dark:text-green-100">Overpayment impact</h3>
      {hasSavings ? (
