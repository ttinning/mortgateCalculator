  ...
  return (
    <div className="rounded-lg bg-amber-50 p-4 ring-1 ring-amber-200">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <h3 className="text-sm font-semibold text-amber-900">Overpaying vs. investing instead</h3>
        <label className="flex items-center gap-2 text-xs text-amber-800">
          ...
          <input
            ...
            min="0"
            step="0.1"
            className="w-20 rounded-md border border-amber-300 px-2 py-1 text-sm focus:border-amber-500 focus:outline-none focus:ring-1 focus:ring-amber-500"
